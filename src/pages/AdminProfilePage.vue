      ...
      <q-page class="admin-profile-page">
        ...
        <div class="admin-content">
          <q-card class="lime-glow">
            <q-card-section>
              <div class="text-h6 text-lime">Admin Profile</div>
              <div class="text-caption text-grey-6 q-mb-lg">Manage your admin account settings</div>
              <div class="text-center q-pa-xl">
                <q-icon name="person" size="64px" color="lime" class="q-mb-md" />
                <div class="text-h6">Profile Page</div>
